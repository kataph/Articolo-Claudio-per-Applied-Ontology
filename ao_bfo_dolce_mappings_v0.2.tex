...
\item[\dbth{d2b_cpart_wext}] $\thdolcedbmap \nvdash \bfocpart(x,y,t) \land x \neq y \to \exists z(\bfocpart(z,y,t) \land z \neq y\land \neg\bfocoverlap(z,x,t))$  \mbox{} \hfill{} {\refbfoax{cpart_wext}}

\item[\dbth{d2b_ex_cprod}] $\thdolcedbmap \nvdash \bfocoverlap(x,y,t) \to \exists z(\forall w(\bfocpart(w,z,t) \ifif \bfocpart(w,x,t) \land 	\bfocpart(w,y,t)))$  \mbox{} \hfill{} {\refbfoax{ex_cprod}}

\item[\dbth{d2b_existence_oprod}] $\thdolcedbmap \nvdash\bfoooverlap(x,y) \to \exists z(\forall w(\bfoopart(w,z) \ifif \bfoopart(w,x) \land \bfoopart(w,y)))$  \mbox{} \hfill{} {\refbfoax{existence_oprod}}
...
%============================================
{\color{red} metti qualche cosa anche vedendo presentazione per Ontocommons oppure togli, non so [FC: ho visto bene i mapping owl]}
